...
import { Box, FormControl, IconButton, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Spinner, useDisclosure, useToast } from '@chakra-ui/react';
        ...
        <>
          ...
          <Modal isOpen={isOpen} onClose={onClose} isCentered>
            ...
            <ModalContent>
              ...
              display={"flex"} justifyContent={"center"} color={"whatsapp.400"}
              ...
              {loading ? (
                ...
                searchResult?.map((user)=>(<UserListItem key={user._id} user={user} 
